...
class CheckServicePoliciesController extends BaseController
{
    use PolicyMatcherFunctions;

    /**
     * @OA\Post(
     *      path="/api/v1/services/authorization/check",
     *      operationId="checkServiceAuthorization",
     *      tags={"Authorization"},
     *      summary="Check service authorization",
     *      description="Check if the request is authorized for the given subject (service)",
     *      security={{"passport":{}}},
     *
     *     @OA\RequestBody(
     *          required=true,
